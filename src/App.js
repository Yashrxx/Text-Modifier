...
function App() {
  ...
  return (
    ...
    <Routes>
      <Route path="/"
      element={<TextForm Heading="Textutils-WordCounter | CharecterCounter | Uppercase to Lowercase | Lowercase to Uppercase"  showalert={showalert} mode={mode} Exampletextarea="Example textarea -007 "/>}
      />
